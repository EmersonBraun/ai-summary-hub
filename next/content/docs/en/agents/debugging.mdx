...
- [OpenTelemetry specification](https://opentelemetry.io/docs/specs/otel/) — Open standard for distributed tracing, metrics, and logging that underpins modern LLM observability tooling.
- [AgentBench: Evaluating LLMs as Agents (Liu et al., 2023)](https://arxiv.org/abs/2308.03688) — Benchmark suite and methodology for systematic agent evaluation across real-world tasks.
- [LangSmith documentation](https://docs.smith.langchain.com/) — Reference for tracing LLM agent calls, building evaluation datasets, and measuring performance.
- [Phoenix (Arize) documentation](https://docs.arize.com/phoenix) — Open-source observability platform supporting OTel traces for any agent framework.
