...
- [LLM Compiler: Parallel Function Calling (Kim et al., 2023)](https://arxiv.org/abs/2312.04511) — Foundational paper on DAG-based parallel tool execution for LLM agents.
- [TaskBench: Benchmarking Large Language Models for Task Automation (Shen et al., 2023)](https://arxiv.org/abs/2311.18760) — Evaluation framework for complex multi-step task planning and DAG decomposition.
- [LangGraph official documentation](https://langchain-ai.github.io/langgraph/) — Reference for graph-based agent state machines used to implement DAG agent patterns.
- [Apache Airflow documentation](https://airflow.apache.org/docs/) — Canonical reference for DAG-based workflow orchestration concepts borrowed by agent frameworks.
