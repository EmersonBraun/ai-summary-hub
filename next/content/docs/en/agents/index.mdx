...
- [ReAct: Synergizing Reasoning and Acting in Language Models (Yao et al., 2022)](https://arxiv.org/abs/2210.03629) — Seminal paper establishing the thought–action–observation agent loop.
- [Cognitive Architectures for Language Agents (Sumers et al., 2023)](https://arxiv.org/abs/2309.02427) — Comprehensive survey of agent reasoning, memory, and action frameworks.
- [Toolformer: Language Models Can Teach Themselves to Use Tools (Schick et al., 2023)](https://arxiv.org/abs/2302.04761) — Key paper on tool-augmented LLMs.
- [Anthropic – Build with Claude: Tool use](https://docs.anthropic.com/en/docs/build-with-claude/tool-use) — Official guide to agentic tool-use patterns.
- [LangChain Agents documentation](https://python.langchain.com/docs/concepts/agents/) — Practical reference for building production agents.
