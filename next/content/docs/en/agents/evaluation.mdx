...
description: >-
  How to measure, benchmark, and systematically test AI agent performance in
...
- [AgentBench: Evaluating LLMs as Agents (Liu et al., 2023)](https://arxiv.org/abs/2308.03688) — Foundational benchmark paper for comprehensive agent evaluation across diverse environments.
- [SWE-bench: Can Language Models Resolve Real-World GitHub Issues? (Jimenez et al., 2023)](https://arxiv.org/abs/2310.06770) — Widely-used benchmark for measuring software engineering agent performance.
- [RAGAS: Automated Evaluation of Retrieval Augmented Generation (Es et al., 2023)](https://arxiv.org/abs/2309.15217) — Framework for faithfulness, context recall, and answer relevance metrics.
- [Chatbot Arena: An Open Platform for Evaluating LLMs by Human Preference (Chiang et al., 2024)](https://arxiv.org/abs/2403.04132) — Human-preference evaluation approach applicable to agent output quality.
