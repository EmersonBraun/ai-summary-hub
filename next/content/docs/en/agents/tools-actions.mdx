...
- [Toolformer: Language Models Can Teach Themselves to Use Tools (Schick et al., 2023)](https://arxiv.org/abs/2302.04761) — Seminal paper on self-supervised tool-use training for LLMs.
- [Gorilla: Large Language Model Connected with Massive APIs (Patil et al., 2023)](https://arxiv.org/abs/2305.15334) — Research on LLM API selection accuracy across thousands of real-world tools.
- [OpenAI Function Calling reference](https://platform.openai.com/docs/guides/function-calling) — Canonical spec for structured tool invocation via JSON Schema.
- [Anthropic Tool Use documentation](https://docs.anthropic.com/en/docs/build-with-claude/tool-use) — Official guide for `tool_use` / `tool_result` patterns in Claude agents.
- [HuggingGPT: Solving AI Tasks with ChatGPT and its Friends in Hugging Face (Shen et al., 2023)](https://arxiv.org/abs/2303.17580) — Demonstrates composing many AI tools via LLM orchestration.
