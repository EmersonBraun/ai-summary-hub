...
- [OWASP Top 10 for LLM Applications](https://owasp.org/www-project-top-10-for-large-language-model-applications/) — Authoritative threat taxonomy for LLM and agent security vulnerabilities.
- [Not What You've Signed Up For: Compromising Real-World LLM-Integrated Applications with Indirect Prompt Injection (Greshake et al., 2023)](https://arxiv.org/abs/2302.12173) — Seminal paper on indirect prompt injection attacks in real-world LLM agent deployments.
- [Constitutional AI: Harmlessness from AI Feedback (Bai et al., 2022)](https://arxiv.org/abs/2212.08073) — Anthropic's approach to principle-based output constraints and safe agent behavior.
- [Anthropic — Strengthen guardrails](https://docs.anthropic.com/en/docs/test-and-evaluate/strengthen-guardrails/mitigate-jailbreaks) — Official guidance on mitigating prompt injection and jailbreaks in Claude agents.
