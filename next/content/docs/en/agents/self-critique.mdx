...
- [Reflexion: Language Agents with Verbal Reinforcement Learning (Shinn et al., 2023)](https://arxiv.org/abs/2303.11366) — Introduces episode-level verbal reflection as a mechanism for agent self-improvement.
- [Self-Refine: Iterative Refinement with Self-Feedback (Madaan et al., 2023)](https://arxiv.org/abs/2303.17651) — Demonstrates iterative self-feedback improving output quality without additional training.
- [Constitutional AI: Harmlessness from AI Feedback (Bai et al., 2022)](https://arxiv.org/abs/2212.08073) — Principle-based self-critique for aligning model outputs to a set of rules.
- [Large Language Models Can Self-Improve (Huang et al., 2022)](https://arxiv.org/abs/2210.11610) — Shows LLMs can generate and select better outputs without labeled training data.
