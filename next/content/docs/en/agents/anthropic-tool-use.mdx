...
- [Anthropic Messages API reference](https://docs.anthropic.com/en/api/messages) — Official spec for the `tools` parameter and `tool_use` / `tool_result` message types.
- [Toolformer: Language Models Can Teach Themselves to Use Tools (Schick et al., 2023)](https://arxiv.org/abs/2302.04761) — Seminal paper on teaching LLMs to use tools via self-supervised learning.
- [ToolBench: Facilitating Large Language Models to Master 16000+ Real-world APIs (Qin et al., 2023)](https://arxiv.org/abs/2307.16789) — Benchmark evaluating LLM tool-use across diverse APIs.
- [Gorilla: Large Language Model Connected with Massive APIs (Patil et al., 2023)](https://arxiv.org/abs/2305.15334) — Research on accurate API/tool selection for LLMs.
