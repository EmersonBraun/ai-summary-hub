...
description: >-
  Architecture where one LLM creates a step-by-step plan and another executes
...
- [Plan-and-Solve: Improving Zero-Shot Chain-of-Thought Reasoning (Wang et al., 2023)](https://arxiv.org/abs/2305.04091) — Paper establishing that explicit planning before execution improves reasoning accuracy.
- [LLM Compiler: Parallel Function Calling (Kim et al., 2023)](https://arxiv.org/abs/2312.04511) — Extends planner-executor with parallel execution of independent subtasks.
- [Reflexion: Language Agents with Verbal Reinforcement Learning (Shinn et al., 2023)](https://arxiv.org/abs/2303.11366) — Replanning via verbal reflection when execution fails.
- [Anthropic — Building Effective Agents](https://www.anthropic.com/research/building-effective-agents) — Official guidance on orchestrator–subagent patterns for production agent systems.
