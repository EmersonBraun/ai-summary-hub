...
- [AutoGen: Enabling Next-Gen LLM Applications via Multi-Agent Conversation (Wu et al., 2023)](https://arxiv.org/abs/2308.08155) — Original paper introducing the AutoGen framework and conversation-driven agent design.
- [AutoGen official documentation](https://microsoft.github.io/autogen/) — Microsoft's authoritative reference for framework architecture and multi-agent patterns.
- [Communicative Agents for Software Development (Qian et al., 2023)](https://arxiv.org/abs/2307.07924) — Related work on LLM-based multi-agent collaboration for complex software tasks.
- [MetaGPT: Meta Programming for A Multi-Agent Collaborative Framework (Hong et al., 2023)](https://arxiv.org/abs/2308.00352) — Complementary multi-agent framework paper showing role-based LLM collaboration.
