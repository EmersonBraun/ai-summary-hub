...
description: >-
  A prompting technique that generates multiple independent chain-of-thought
  reasoning paths and selects the final answer by majority vote, significantly
  improving reliability over single-pass chain-of-thought.
tags:
  - intermediate
---
