...
description: >-
  Techniques that prompt an LLM to assess the quality and confidence of its own
  outputs — enabling iterative self-correction, uncertainty quantification, and
  more trustworthy responses without external supervision.
tags:
  - advanced
---
