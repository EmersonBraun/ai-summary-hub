...
description: >-
  System messages, role prompting, and contextual prompting are foundational
  techniques for steering LLM behavior — establishing persistent instructions,
  personas, and background knowledge before the conversation begins.
tags:
  - beginner
---
