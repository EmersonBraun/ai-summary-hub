...
- [Tree of Thoughts: Deliberate Problem Solving with Large Language Models (Yao et al., 2023)](https://arxiv.org/abs/2305.10601) — Seminal paper introducing multi-path tree search over reasoning steps with benchmarks on Game of 24 and creative writing.
- [Large Language Model Guided Tree-of-Thought (Long, 2023)](https://arxiv.org/abs/2305.08291) — Concurrent work on tree-structured reasoning with LLM-based pruning.
- [Chain-of-Thought Prompting Elicits Reasoning in Large Language Models (Wei et al., 2022)](https://arxiv.org/abs/2201.11903) — Foundation that ToT extends from single-path to multi-path reasoning.
- [Self-Consistency Improves Chain of Thought Reasoning in Language Models (Wang et al., 2022)](https://arxiv.org/abs/2203.11171) — Related sampling-based approach that ToT generalizes with structured search.
