...
title: Terraform
description: >-
  Declarative Infrastructure as Code tool by HashiCorp for provisioning and
  managing cloud resources, widely used to create reproducible ML infrastructure
  including GPU instances, storage buckets, and Kubernetes clusters.
tags:
  - advanced
---
