...
- [Chain-of-Thought Prompting Elicits Reasoning in Large Language Models (Wei et al., 2022)](https://arxiv.org/abs/2201.11903) — Artigo seminal que introduz o prompting CoT com few-shot e demonstra melhorias dramáticas de raciocínio.
- [Large Language Models Are Zero-Shot Reasoners (Kojima et al., 2022)](https://arxiv.org/abs/2205.11916) — Introduz o CoT zero-shot ("Let's think step by step") sem necessidade de exemplos.
- [Self-Consistency Improves Chain of Thought Reasoning in Language Models (Wang et al., 2022)](https://arxiv.org/abs/2203.11171) — A votação majoritária sobre múltiplos caminhos CoT melhora significativamente a confiabilidade.
- [Tree of Thoughts: Deliberate Problem Solving with Large Language Models (Yao et al., 2023)](https://arxiv.org/abs/2305.10601) — Estende o CoT para busca em múltiplos caminhos, evidenciando a limitação do caminho único do CoT.
