...
- [Retrieval-Augmented Generation for Knowledge-Intensive NLP Tasks (Lewis et al., 2020)](https://arxiv.org/abs/2005.11401) — Artigo fundamental sobre RAG que fornece a base de recuperação para o passo de busca de specs do RDD.
- [Constitutional AI: Harmlessness from AI Feedback (Bai et al., 2022)](https://arxiv.org/abs/2212.08073) — Abordagem baseada em princípios para guiar e validar decisões do modelo contra regras recuperadas.
- [Self-RAG: Learning to Retrieve, Generate, and Critique through Self-Reflection (Asai et al., 2023)](https://arxiv.org/abs/2310.11511) — Estende a geração aumentada por recuperação com autocrítica inline, complementar ao passo de validação do RDD.
- [ReAct: Synergizing Reasoning and Acting in Language Models (Yao et al., 2022)](https://arxiv.org/abs/2210.03629) — Loop de agente que o RDD compõe para raciocínio em nível de etapa dentro do ciclo recuperar–decidir–projetar.
