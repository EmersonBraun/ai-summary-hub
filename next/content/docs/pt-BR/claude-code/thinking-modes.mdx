...
description: >-
  Extended thinking no Claude Code — o que é, como os níveis de esforço afetam a
  profundidade do raciocínio versus velocidade, e como configurar o
  comportamento de raciocínio para diferentes tipos de tarefas.
tags:
  - intermediate
---
