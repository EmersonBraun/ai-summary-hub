...
description: >-
  Arquivos de instrução no nível do projeto e global que personalizam o
  comportamento do Claude Code — o que são, onde ficam, como são carregados e
  como escrever bons exemplos.
tags:
  - beginner
---
