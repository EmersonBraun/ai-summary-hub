...
description: >-
  Como o Claude Code gerencia a janela de contexto em sessões longas —
  compressão automática, estratégias de histórico de conversas e técnicas
  práticas para manter as sessões eficazes em escala.
tags:
  - intermediate
---
