...
title: Claude Code
description: >-
  Assistente de codificação por IA agêntico da Anthropic disponível como CLI,
  extensão para VS Code/JetBrains e aplicativo web — capaz de execução autônoma
  de tarefas em múltiplas etapas em toda a sua base de código.
tags:
  - beginner
---
