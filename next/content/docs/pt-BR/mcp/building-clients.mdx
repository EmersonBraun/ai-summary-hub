...
description: >-
  Como construir clientes MCP que conectam aplicações de IA a servidores MCP —
  cobrindo inicialização do cliente, descoberta de capacidades, invocação de
  ferramentas, leitura de recursos e seleção de transporte.
tags:
  - advanced
---
