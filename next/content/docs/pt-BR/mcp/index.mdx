...
description: >-
  Um padrão aberto para conectar modelos de IA a ferramentas externas, fontes de
  dados e serviços — habilitando uso de ferramentas portável e interoperável em
  qualquer aplicação de IA.
tags:
  - intermediate
---
