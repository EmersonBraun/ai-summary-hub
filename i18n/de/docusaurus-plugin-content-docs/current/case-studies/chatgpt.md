...
They illustrate die vollständige [LLM](/docs/llms) Stack: vortrainiertes Basismodell, Instruktions-Tuning und [RL](/docs/rl)-basierte Ausrichtung (RLHF). Die gleichen Ideen (Instruktions-Tuning, Präferenzoptimierung) appear in open and other proprietary models. Use case: chat, [prompt](/docs/prompt-engineering)-driven tasks, and [agent](/docs/agents)-like workflows with tools.
