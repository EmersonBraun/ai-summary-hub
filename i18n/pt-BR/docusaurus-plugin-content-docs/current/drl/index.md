...
description: Combinando aprendizado profundo com aprendizado por reforço para aprender políticas complexas.
keywords: [DRL, deep reinforcement learning, policy gradient, Q-learning, actor-critic]
tags: [advanced]
