...
- [Anthropic API 参考](https://docs.anthropic.com/en/api/getting-started) — 包含请求/响应 schema 和参数参考的完整端点文档
- [Anthropic 提示工程指南](https://docs.anthropic.com/en/docs/build-with-claude/prompt-engineering/overview) — 系统提示、思维链和特定任务技术的官方最佳实践
- [Anthropic Cookbook](https://github.com/anthropics/anthropic-cookbook) — 涵盖工具使用、RAG、多模态、提示缓存和代理的可运行笔记本
- [Claude 模型概览](https://docs.anthropic.com/en/docs/about-claude/models) — 当前模型 ID、上下文窗口、能力对比和弃用时间表
- [GitHub 上的 Anthropic Python SDK](https://github.com/anthropics/anthropic-sdk-python) — 源代码、变更日志、类型存根和迁移指南

## 另请参阅

- [模型提供商](/docs/model-providers) — 所有提供商的概述和对比，包括 7 提供商对比表
- [案例研究：Claude](/docs/case-studies/claude) — 深入了解模型架构和训练方法
- [OpenAI](/docs/model-providers/openai) — GPT-4o、o 系列推理、函数调用、DALL-E、Whisper
- [提示工程](/docs/prompt-engineering) — 适用于所有 Claude 模型的技术
- [工具](/docs/tools/claude-code) — Claude Code，Anthropic 基于 Claude API 构建的 AI 编码代理
