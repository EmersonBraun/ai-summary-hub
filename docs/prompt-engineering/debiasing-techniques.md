...
description: Debiasing techniques are prompt-level and evaluation strategies for identifying and reducing systematic bias in LLM outputs — covering social biases, sycophancy, positional effects, and evaluation distortions — to produce fairer and more reliable responses.
