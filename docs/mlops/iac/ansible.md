---
title: Ansible
description: Agentless configuration management and automation tool that uses declarative YAML playbooks to configure servers, install software, and manage ML training environments at scale.
keywords: [Ansible, configuration management, playbooks, roles, inventory, agentless, CUDA, GPU drivers, ML environment, IaC]
tags: [advanced]
