---
title: Model serving
description: Strategies and frameworks for deploying ML models as scalable inference services — batch, real-time, and streaming.
keywords: [model serving, inference, TorchServe, TF Serving, Triton, BentoML, FastAPI, batch inference, real-time API, streaming]
tags: [intermediate]
